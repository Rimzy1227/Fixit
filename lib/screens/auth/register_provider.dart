...
class _RegisterProviderScreenState extends State<RegisterProviderScreen> {
  ...
  // Pick certification file (optional)
  ...
  Future<void> _registerProvider() async {
    ...
    try {
      // Create Firebase Auth account for provider
      ...
      // Go back to contractor dashboard
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Service Type (e.g., Plumber, Electrician)'),
              ),
              const SizedBox(height: 10),
